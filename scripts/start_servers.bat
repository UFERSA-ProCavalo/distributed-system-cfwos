...
start wt cmd /k "cd /d %PROJECT_DIR% && title Proxy Server && echo Starting Proxy Server on port 22220... && java -cp bin server.proxy.ProxyServer"
...
start wt cmd /k "cd /d %PROJECT_DIR% && title Application Server && echo Starting Application Server on port 33330... && java -cp bin server.application.ApplicationServer"
